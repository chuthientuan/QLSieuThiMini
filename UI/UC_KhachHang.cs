...
namespace QLSieuThiMini.UI
{
    public partial class UC_KhachHang : UserControl
    {
        ...
        private void btnXoa_Click(object sender, EventArgs e)
        {
            ...
            {
                dtBase.DataChange("delete KhachHang where DienThoai = N'" + txtDienThoai.Text + "'");
                dvgKhachHang.DataSource = dtBase.DataReader("Select * from KhachHang");
        ...
        private void btnTimKiem_Click(object sender, EventArgs e)
        {
            ...
            {
                sql += " AND (DienThoai LIKE '%" + txtTimKiem.Text.Trim() + "%' OR TenKH LIKE N'%" + txtTimKiem.Text.Trim() + "%')";
            }
            else
            {
